...
class ProficiencyPostsControllerTest < ActionController::TestCase
  ...
  #test "should get index" do
    #get :index, :proficiency => "MyString", :game => 1
    #assert_response :success
    #assert_not_nil assigns(:proficiency_posts)
  #end

  #test "should get new" do
    #get :new, :proficiency => "MyString", :game => 1
    #assert_response :success
  #end

  #test "should create proficiency_post" do
    #assert_difference('ProficiencyPost.count') do
      #post :create, proficiency_post: { content: @proficiency_post.content, date: @proficiency_post.date, title: @proficiency_post.title, username: @proficiency_post.username }, :proficiency => "MyString", :game => 1
    #end
  ...
  #test "should get edit" do
    #get :edit, id: @proficiency_post, :proficiency => "MyString", :game => 1
    #assert_response :success
  #end
